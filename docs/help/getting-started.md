...
5. Choose **Process Prepared Items** to confirm how many documents are ready. Carrot submission remains pending.
6. Select **Start Over**, **Back to Main Menu**, or **Exit** when finished.
